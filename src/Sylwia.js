...
class Sylwia extends React.Component {
	state = {
		strength: 4,
		agility: 4,
		intelligence: 4,
		...
		return (
			<div className="app">
				<div className="section">
					<h3>
						<span className="textInput">Imię:</span>Sylwia
					</h3>
					<h3>
						<span className="textInput">Profesja:</span>były akrobata
					</h3>
				</div>
